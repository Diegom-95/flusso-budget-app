...
public final class ExpenseDao_Impl implements ExpenseDao {
  ...
  public ExpenseDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfExpense = new EntityInsertionAdapter<Expense>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `expenses` (`id`,`date`,`description`,`category`,`amount`,`isSubscription`,`isNeed`,`notes`,`month`,`year`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(9, entity.getMonth());
    ...
    this.__updateAdapterOfExpense = new EntityDeletionOrUpdateAdapter<Expense>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `expenses` SET `id` = ?,`date` = ?,`description` = ?,`category` = ?,`amount` = ?,`isSubscription` = ?,`isNeed` = ?,`notes` = ?,`month` = ?,`year` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object insert(final Expense e, final Continuation<? super Unit> $completion) {
  ...
  @Override
  public Object delete(final Expense e, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object update(final Expense e, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public LiveData<List<Expense>> getByMonth(final int m, final int y) {
      ...
      public List<Expense> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Expense(_tmpId,_tmpDate,_tmpDescription,_tmpCategory,_tmpAmount,_tmpIsSubscription,_tmpIsNeed,_tmpNotes,_tmpMonth,_tmpYear);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public LiveData<List<Expense>> getByYear(final int y) {
    final String _sql = "SELECT * FROM expenses WHERE year=? ORDER BY date DESC";
  ...
  public LiveData<Double> getTotalByMonth(final int m, final int y) {
    final String _sql = "SELECT SUM(amount) FROM expenses WHERE month=? AND year=?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, m);
    _argIndex = 2;
  ...
  @Override
  public LiveData<Double> getNeedsTotalByMonth(final int m, final int y) {
    final String _sql = "SELECT SUM(amount) FROM expenses WHERE month=? AND year=? AND isNeed=1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, m);
    _argIndex = 2;
  ...
  @Override
  public LiveData<Double> getSubscriptionsTotalByMonth(final int m, final int y) {
    final String _sql = "SELECT SUM(amount) FROM expenses WHERE month=? AND year=? AND isSubscription=1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, m);
    _argIndex = 2;
  ...
  @Override
  public LiveData<List<Expense>> getRecent() {
    final String _sql = "SELECT * FROM expenses ORDER BY date DESC LIMIT 20";
  ...
  public Object exists(final String date, final String cat, final double amt, final int m,
    ...
    final String _sql = "SELECT COUNT(*) FROM expenses WHERE date=? AND category=? AND ABS(amount-?)<0.001 AND month=? AND year=?";
  ...
  @Override
  public Object getByYearSync(final int y, final Continuation<? super List<Expense>> $completion) {
    final String _sql = "SELECT * FROM expenses WHERE year=? ORDER BY date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, y);
