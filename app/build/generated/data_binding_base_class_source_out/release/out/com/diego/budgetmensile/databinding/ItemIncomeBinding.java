...
public final class ItemIncomeBinding implements ViewBinding {
  ...
  private ItemIncomeBinding(@NonNull CardView rootView, @NonNull ImageButton btnDelete,
      @NonNull Chip chipActive, @NonNull TextView tvAmount, @NonNull TextView tvCategory,
  ...
  public static ItemIncomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemIncomeBinding((CardView) rootView, btnDelete, chipActive, tvAmount, tvCategory,
